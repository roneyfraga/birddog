...
![](https://roneyfraga.com/volume/keep_it/cnpq-pq-horizontal.svg){width=95%}
...
![](https://roneyfraga.com/volume/keep_it/biogas-data/key_route_example.png){width=99%}
...
```{r}
key_route_c1g3_data |>
  dplyr::select(name = name2, title = TI) |>
