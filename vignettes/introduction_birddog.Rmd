...
groups_cumulative_citations <- readRDS('~/Sync/birddog-data/wos-sugarcane-groups-cumulative-citations.rds')
...
net_cct <- readRDS('~/Sync/birddog-data/wos-sugarcane-net-cct.rds')
...
```{r eval = T, fig.width = 9, fig.height = 12}
...
net_key_route <- sniff_key_route(net_dc_topn, scope = 'network')
...
groups_dc <- birddog::sniff_groups(comps_dc, algorithm = 'fast_greedy', min_group_size = 30, groups_short_name = TRUE)
