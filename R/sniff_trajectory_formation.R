#' Track which trajectories fed into a given trajectory
#'
...
#'   "c1g10::tr1",
#'   all_detected = groups_detected_trajectories,
...
#' }
#'
#' @seealso [sniff_trajectory_destination()], [plot_trajectory_formation_2d()]
#'
#' @importFrom dplyr filter pull mutate arrange desc bind_rows
#' @importFrom tibble tibble
#' @importFrom rlang .data
#' @export
sniff_trajectory_formation <- function(target,
                                       all_detected,
                                       docs_per_group,
                                       last_year = NULL,
                                       min_papers = 5,
