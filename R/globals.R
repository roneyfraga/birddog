utils::globalVariables(c(
  ...
  "average_age_group", "weight", "index", "PY.sd", "deg",
  ".ggraph.orig_index", "year", "sugiyama", "x", "y", "size", "id",
  "publications", "py", "py_sd", "keywords_last_year",
  "stm_prepare", "texto", "TIpost", "cited_from", "Ki", "ki", "Zi", "Pi",
  "text", "Cutpoints", "coefficient", "growth_rate_percentage_year",
