...
#' \dontrun{
#' # Group analysis
#' results <- sniff_cct(network_groups, scope = "groups")
#'
#' # Network analysis
#' results_network <- sniff_cct(complete_network, scope = "network")
#'
#' # With rolling window smoothing
#' results_smooth <- sniff_cct(
#'   network_groups,
#'   scope = "groups",
#'   rolling_window = 3
#' )
