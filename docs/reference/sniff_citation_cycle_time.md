...
if (FALSE) { # \dontrun{
# Group analysis
results <- sniff_citation_cycle_time(network_groups, scope = "groups")

# Network analysis
results_network <- sniff_citation_cycle_time(complete_network, scope = "network")

# With rolling window smoothing
results_smooth <- sniff_citation_cycle_time(
  network_groups,
  scope = "groups",
  rolling_window = 3
)
...
results_norm <- sniff_citation_cycle_time(
  network_groups,
  scope = "groups",
  normalize = "domain"
)
...
results_disp <- sniff_citation_cycle_time(
  network_groups,
  scope = "groups",
  dispersion = TRUE
)
...
results_local <- sniff_citation_cycle_time(
  network_groups,
  scope = "groups",
...
results2 <- sniff_citation_cycle_time(
  network_groups,
