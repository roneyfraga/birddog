# Minimal fixture for plot_group_trajectories_2d(): one group c1g1 whose lineage
...
test_that("plot_group_trajectories_2d returns a ggplot with default coloring", {
  fx <- make_group_traj_fixture()
  p <- plot_group_trajectories_2d(fx, group = "c1g1")
  expect_s3_class(p, "ggplot")
})

test_that("plot_group_trajectories_2d colors by final_group_share", {
  fx <- make_group_traj_fixture()
  p <- plot_group_trajectories_2d(fx, group = "c1g1", color_by = "final_group_share")
  expect_s3_class(p, "ggplot")
})
